...
<div class="page-content">
    ...
    <div class="content-wrapper">
        ...
        <div class="content d-flex justify-content-center align-items-center">
            ...
            <!-- Login form -->
            <form method="POST" action="{{ route('login') }}" accept-charset="UTF-8" class="login-form" id="login_form" autocomplete="off">
                @csrf
                <div class="card mb-0">
                    <div class="card-body">
                        <div class="text-center">
                            ...
                            <span class="d-block text-muted mb-3">Silahkan login terlebih dulu</span>
                        </div>
                        ...
                        <a href="https://siakng.undiksha.ac.id" class="btn bg-pink btn-block legitRipple">Login Dengan SSO</a>
                    </div>
                </div>
            </form>
            <!-- /login form -->
