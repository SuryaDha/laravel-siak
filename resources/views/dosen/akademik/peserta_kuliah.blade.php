...
<div class="content-wrapper">
    ...
    <div class="page-header-content header-elements-md-inline">
        <div class="page-title d-flex">
            <h4><span class="font-weight-semibold">Daftar Peserta Kuliah</span></h4>
        </div>
    </div>
</div>
    </div>
...
<div class="card">
    ...
    <table class="table datatable-basic" id="table_data">
        ...
        <tbody>
                    ...
                    <td>-</td>
                    <td>
                        <a href="#" class="btn alpha-success text-success-800 btn-icon btn-sm">Unduh Excel</a>
                        <a href="javascript:void(0)" onclick="mainDeleteConfirm('')" class="btn alpha-danger text-danger-800 btn-icon btn-sm">Unduh PDF</a>
                    </td>
                </tr>
