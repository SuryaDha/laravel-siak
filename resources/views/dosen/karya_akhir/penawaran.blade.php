...
<div class="content-wrapper">
    ...
    <div class="page-header-content header-elements-md-inline">
        <div class="page-title d-flex">
            <h4><span class="font-weight-semibold">Karya Akhir</span> - Penawaran Topik</h4>
        </div>
    </div>
</div>
    </div>
...
<form action="" id="form_filter">
    <div class="card">
        <div class="card-body">
            ...
            <div class="row">
                <label class="col-form-label col-md-2 text-left">Filter Data : </label>
                <div class="col-md-3">
                ...
                <div class="col-md-1">
                    <button type="submit" class="btn btn-primary">Buat Penawaran Topik</button>
                </div>
            </div>
        </div>
    </div>
